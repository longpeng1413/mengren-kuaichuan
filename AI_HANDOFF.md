...
- 当前修复版：v1.7.1+14，基于 GitHub `v1.7.0` 标签开发；修复分支为 `codex/fix-v1.7.0-remote-progress-stability`。
- v1.7.1 将公网加解密移出 Flutter UI isolate，采用 4 块有限流水窗口，并新增接收端停止、45 秒无数据清理、进度限频和 8 MiB 写盘背压。
...
先核对 `docs/开发交接说明-v1.7.1.md` 的修复与 VPS 现状；不得改动原个人网站 Caddy 站点。下一步是两地实机回归，任何密码、令牌或私钥都不得提交到 Git。
