...
- 当前修复版：v1.7.3+16，基于 GitHub `v1.7.2` 继续开发；修复分支为 `codex/fix-v1.7.1-relay-throughput`。
...
先核对 `docs/开发交接说明-v1.7.3.md` 的修复、发布校验值与 VPS 现状；不得改动原个人网站 Caddy 站点。下一步是完成有线 Windows 与 Wi-Fi Android 的自动发现、直连路线和两地 100–200 MiB 实机回归，任何密码、令牌或私钥都不得提交到 Git。
